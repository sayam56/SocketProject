...
void proxy_to_mirror(int client_sd)
{
    ...
    printf("Mirror FD created\n");

    mirror_addr.sin_family = AF_INET;
    mirror_addr.sin_port = htons(9004);
    ...
    printf("Connection to proxy mirror completed\n");

    // handling comms betwenn client and mirror
    fd_set set;
    char buffer[1024];
    while (1)
    {
